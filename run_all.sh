...
bazel-bin/cabby/rvs/generate_rvs --start_lat 44.49582 --start_lon 11.33697 --goal_lat 44.49268 --goal_lon 11.34365 --region DC --min_s2_level 18 --directory "./cabby/geo/map_processing/poiTestData/" 
