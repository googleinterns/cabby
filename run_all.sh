...
bazel-bin/cabby/data/extract_wikigeo_contexts --region $REGION_NAME --output_dir /tmp/wikigeo --osm_path  "/tmp/poiTestData/pittsburgh_small_poi.pkl"

echo "****************************************"
echo "*                 RVS                  *"
echo "****************************************"
bazel-bin/cabby/rvs/generate_rvs --rvs_data_path "/tmp/pittsburgh_small_geo_paths.gpkg" --save_instruction_path "/tmp/pittsburgh_small_instructions.json" 
