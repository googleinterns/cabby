...
# Wikigeo
bazel-bin/cabby/data/extract_wikigeo_contexts --region Pittsburgh_small --output_dir /tmp/wikigeo
bazel-bin/cabby/data/extract_wikigeo_contexts --region Pittsburgh_small --output_dir /tmp/wikigeo --osm_path  "./cabby/geo/map_processing/poiTestData/pittsburgh_small_poi.pkl"
