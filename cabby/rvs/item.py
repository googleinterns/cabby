...
<<<<<<< HEAD:cabby/geo/item.py
    ...
    `cardinal_direction` is the cardinal direction betweeen main pivot and goal. Possible cardinal directions: North, South, East, West, North-East, 
