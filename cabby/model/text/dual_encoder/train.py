...
class Trainer:
  ...
  def reranker(
    ...
    # Get cellids from labels.
    batch_top_cellids= np.vectorize(self.label_to_cellid.get)(top_idx)
    
    probabilities = np.zeros_like(batch_top_cellids)
