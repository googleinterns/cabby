...
def create_dataset(
  ...
  return dataset_item.TextGeoDataset.from_TextGeoSplit(
    ...
    np.array(human_dataset.unique_cellid), 
    tens_cells, human_dataset.label_to_cellid)
