...
flags.DEFINE_string(
    ...
    help=('Directory to read MORP data from.'))
...
def train_and_evaluate(
        seed, model_dir, data_dir,
        num_epochs, batch_size, embedding_size, hidden_size,
  ...
  Args:
    ...
    data_dir: Directory containing train, dev and test examples.
...
def main(argv):
  ...
  train_and_evaluate(
      seed=FLAGS.seed, model_dir=FLAGS.model_dir, 
      data_dir=FLAGS.data_dir, num_epochs=FLAGS.num_epochs,
