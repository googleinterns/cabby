...
SUPPORTED_REGIONS = [
  ...
  Region(
    name='RUN-map1',
    polygon=box(minx=-73.99944, miny=40.7484699999999, maxx=0, maxy=40.7535699999999),
  ),
  Region(
    name='RUN-map2',
    polygon=box(minx=-73.98732, miny=40.723, maxx=0, maxy=40.7277),
  ),
  Region(
    name='RUN-map3',
    polygon=box(minx=-74.00518, miny=40.74154, maxx=0, maxy=40.74624),
  )        
]
