...
def pick_prominent_pivot(df_pivots: GeoDataFrame) -> Optional[GeoDataFrame]:
  ...
  pivot = check_if_tag_exists_set_main_tag(df_pivots, 'wikipedia', 'name', 'amenity')
  if pivot is not None:
    return pivot
  
  pivot = check_if_tag_exists_set_main_tag(df_pivots, 'wikidata', 'name', 'amenity')
  if pivot is not None:
    return pivot

  pivot = check_if_tag_exists_set_main_tag(df_pivots, 'brand', 'name', 'brand')
  if pivot is not None:
    return pivot
  
  pivot = check_if_tag_exists_set_main_tag(df_pivots, 'tourism', 'name', 'tourism')
  if pivot is not None:
    return pivot
